...
--2025-04-15 10:58:00--  https://challenge-files.picoctf.net/c_verbal_sleep/babfbee79718a6363826ba86300173ffde6d81577e9dd07d4130c53a7eecf6c3/fixme2.tar.gz
Resolving challenge-files.picoctf.net (challenge-files.picoctf.net)... 65.9.149.85, 65.9.149.95, 65.9.149.24, ...
...
2025-04-15 10:58:00 (17.9 MB/s) - ‘fixme2.tar.gz’ saved [1585/1585]
...
Entramos a la carpeta y compilamos el programa.
...
└─$ cargo build
   ...
   Compiling rust_proj v0.1.0 (/home/chris/fixme2)
...
Detectamos errores de compilación así que vamos a corregirlos
...
└─$ cargo run
    Finished `dev` profile [unoptimized + debuginfo] target(s) in 0.01s
     Running `/home/chris/fixme2/target/debug/rust_proj`
Using memory unsafe languages is a: PARTY FOUL! Here is your flag: picoCTF{4r3_y0u_h4v1n5_fun_y31?}
```

Así, obtenemos la bandera

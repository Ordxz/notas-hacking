...
Vamos a hacer lo mismo que en los ejercicios anteriores, descargamos el archivo adjunto y extraemos la carpeta comprimida.
...
--2025-04-15 11:12:42--  https://challenge-files.picoctf.net/c_verbal_sleep/dcdaf491b35c1d0f5075e9583edbbb7aaea1dffb6ad32bc000e4d87b5200ff7b/fixme3.tar.gz
Resolving challenge-files.picoctf.net (challenge-files.picoctf.net)... 65.9.149.95, 65.9.149.24, 65.9.149.59, ...
...
2025-04-15 11:12:42 (73.3 MB/s) - ‘fixme3.tar.gz’ saved [1776/1776]
...
De igual manera, compilamos el programa, pero tenemos un error y debemos corregirlo

```shell
┌──(chris㉿Chris)-[~/fixme3/src]
└─$ cargo build
   ...
   Compiling rust_proj v0.1.0 (/home/chris/fixme3)
...
Primero teníamos esto, donde está comentado el block de unsafe.
...
Le quitamos el comentario y ahora compilamos
...
└─$ cargo run
    Finished `dev` profile [unoptimized + debuginfo] target(s) in 0.02s
     Running `/home/chris/fixme3/target/debug/rust_proj`

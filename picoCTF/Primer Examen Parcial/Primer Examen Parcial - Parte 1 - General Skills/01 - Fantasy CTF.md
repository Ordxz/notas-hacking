...
Connect to the program with netcat:`$ nc verbal-sleep.picoctf.net 52486`
### Solución
Iniciamos este reto abriendo una terminal en Kali Linux e ingresando el comando proporcionado en la descripción:
...
Otra vez se nos muestra un menú de opciones donde procederé a jugar el juego con la opción **A**:
...
Al completar el juego, nos dice que terminó, además de algunos mensajes más, nos da la bandera.
